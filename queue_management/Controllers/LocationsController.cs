...
namespace queue_management.Controllers
{
    public class LocationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("LocationID,LocationName,Address,Country,Department,Region,Municipality,City,PhoneNumber")] Location location)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LocationID,LocationName,Address,Country,Department,Region,Municipality,City,PhoneNumber")] Location location)
        {
